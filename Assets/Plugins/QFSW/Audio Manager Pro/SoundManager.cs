...
namespace AMPInternal
{
    ...
    public abstract class SoundManager : MonoBehaviour
    {
        ...
        private void FlushVolumeChange() { for (int i = 0; i < ActiveAudio.Count; i++) { ActiveAudio[i].volume = ActiveAudio[i].volume; } }
        ...
        public AudioObject StartAudio(AudioClip Audio, bool Looping, bool AutoPlay = true)
        {
            ...
            else
            {
                ...
                if (Mixer != null) { ReturnedAudio.Source.outputAudioMixerGroup = Mixer; }
            }
